...
const RELOCATION_CITY_CONFIG: Record<RelocationCityConfig["slug"], RelocationCityConfig> = {
  madrid: {
    slug: "madrid",
    cityName: "Madrid",
    heroTitle: "Business relocation in Madrid",
    heroSubtitle:
      "Office, retail, and warehouse moves in Madrid and the wider region with a B2B-focused logistics partner.",
    seoTitle: "Office relocation in Madrid | S&Z Trading",
    seoDescription:
      "Professional business relocation in Madrid. Office, warehouse, and commercial moves with minimal downtime.",
  },
  malaga: {
    slug: "malaga",
    cityName: "Málaga",
    heroTitle: "Business relocation in Málaga",
    heroSubtitle:
      "Office, retail, and warehouse relocations in Málaga and the Costa del Sol with detailed planning and specialist crews.",
    seoTitle: "Office relocation in Málaga | S&Z Trading",
    seoDescription:
      "Business relocations in Málaga and the Costa del Sol. Professional office, warehouse, and commercial moves with end-to-end support.",
  },
};
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg">
                <Link to="/get-quote" state={{ serviceType: "relocation", city: cityConfig.cityName }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            <Card className="lg:col-span-2">
              ...
              <CardContent className="space-y-4 text-muted-foreground text-sm">
                <p>
                  We handle relocations for offices, shops, warehouses, and light industrial spaces. The move plan is adapted to your
                  volumes, timelines, and access restrictions at both origin and destination.
                </p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Office furniture, workstations, and archives</li>
                  <li>Sensitive IT equipment and electronics</li>
                  <li>Racking, stock, and palletised goods</li>
                  <li>Light machinery and non-fixed equipment</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-2 text-sm text-muted-foreground">
                <p>
                  We coordinate local moves in {cityConfig.cityName} as well as regular regional and European routes, including:
                </p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Moves within the city and surrounding metropolitan area</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                <p>
                  When needed, we plan moves outside business hours: evenings, nights, weekends, and local holidays to reduce impact on
                  your operation.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                <p>
                  Vehicles are selected according to your cargo profile, with extended insurance options for high-value equipment or
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                <p>
                  Familiarity with {cityConfig.cityName} specifics: access points, loading and unloading windows, and typical traffic
                  restrictions.
                </p>
              </CardContent>
            </Card>
            ...
            <Button asChild variant="outline" className="justify-between text-left">
              <Link to="/resources/office-move-checklist">
                <span>
                  ...
                  <span className="block text-xs text-muted-foreground">
                    Make sure your office relocation stays on track.
                  </span>
                </span>
              </Link>
            </Button>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="text-lg md:text-xl mb-8 text-white/90">
            Share origin, destination, and approximate dates and we will prepare a detailed relocation plan and clear quote.
          </p>
